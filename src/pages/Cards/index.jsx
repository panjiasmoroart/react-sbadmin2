...
const Cards = () => {
  ...
  const dropdownCard = useDropdown("dropdownCard");
  const collapsableCard = useDropdown("collapsableCard");

  useOutsideClick(dropdownCardRef, () => {
    if (dropdownCard.isOpen) dropdownCard.toggle();
  });
              ...
              <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                >
                  <a
                    ...
                    aria-haspopup="true"
                    aria-expanded={dropdownCard.isOpen}
                    onClick={(e) => {
                      e.preventDefault();
                      dropdownCard.toggle();
                    }}
            ...
            <div className="card shadow mb-4">
              ...
              <a
                ...
                className={`d-block card-header py-3 ${
                  collapsableCard.isOpen ? "collapsed" : ""
                }`}
                data-toggle="collapse"
                role="button"
                aria-expanded={collapsableCard.isOpen}
                onClick={(e) => {
                  e.preventDefault();
              ...
              <div
                className={`collapse ${collapsableCard.isOpen ? "" : "show"}`}
