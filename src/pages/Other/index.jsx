...
const UtilitiesOther = () => {
  const dropdownNoarrowRef = useRef(null);

  const dropdownNoarrow = useDropdown("dropdownNoarrow");

  useOutsideClick(dropdownNoarrowRef, () => {
    if (dropdownNoarrow.isOpen) dropdownNoarrow.toggle();
  });
      ...
      <div>
        ...
        <div className="row">
          <div className="col-lg-6">
            ...
            {/* Dropdown No Arrow */}
            <div
              className={`card mb-4 ${dropdownNoarrow.isOpen ? "show" : ""}`}
            >
              <div className="card-header py-3">
                <h6 className="m-0 font-weight-bold text-primary">
                  Dropdown - No Arrow
              ...
              <div className="card-body">
                <div className="dropdown no-arrow mb-4">
                  <button
                    ...
                    aria-haspopup="true"
                    aria-expanded={dropdownNoarrow.isOpen}
                    onClick={(e) => {
                      e.preventDefault();
                      dropdownNoarrow.toggle();
                    }}
                    ref={dropdownNoarrowRef}
                  >
                    Dropdown (no arrow)
                  </button>
                  <div
                    className={`dropdown-menu ${
                      dropdownNoarrow.isOpen ? "show" : ""
                    }`}
