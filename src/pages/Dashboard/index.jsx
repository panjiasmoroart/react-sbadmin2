...
const AreaChart = lazy(() => import("../../components/Charts/Area"));
const RevenueSources = lazy(() => import("../../components/Charts/Pie"));

const Dashboard = () => {
  const earningsDropdownRef = useRef(null);
  const earningsDropdown = useDropdown("earnings");

  useOutsideClick(earningsDropdownRef, () => {
    if (earningsDropdown.isOpen) earningsDropdown.toggle();
  });
      ...
      <div>
        ...
        <div className="row">
              ...
              <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <div
                  className={`dropdown no-arrow ${
                    earningsDropdown.isOpen ? "show" : ""
                  }`}
                >
                  <a
                    ref={earningsDropdownRef}
                    ...
                    aria-haspopup="true"
                    aria-expanded={earningsDropdown.isOpen}
                    onClick={(e) => {
                      e.preventDefault();
                      earningsDropdown.toggle();
                    }}
                  >
          ...
          <div className="col-xl-4 col-lg-5">
            <CardDefault title="Revenue Sources">
              <Suspense
                fallback={
                  <div
                    className="d-flex justify-content-center align-items-center"
            ...
            <div className="card shadow mb-4">
              ...
              <div className="card-body">
                <div className="text-center">
                  <img
                    className="img-fluid px-3 px-sm-4 mt-3 mb-4 a-6"
                    style={{ width: "25rem" }}
